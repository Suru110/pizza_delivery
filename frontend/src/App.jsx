...
const API_URL = import.meta.env.VITE_API_URL || 'https://pizza-delivery-s1ax.onrender.com/api';
const SOCKET_URL = import.meta.env.VITE_SOCKET_URL || 'https://pizza-delivery-s1ax.onrender.com';
